...
sources:
- https://expedition33.wiki.fextralife.com/Duollison
...
- *Lvl. 4* — Each successive base attack hit on the same turn deals 100% more damage.
- *Lvl. 10* — Free Aim shots apply 1 Foretell. Base attack consumes all Foretell to deal 50% more damage per Foretell consumed. Lvl: 20 : During Twilight, any Foretell consumed is not removed.
